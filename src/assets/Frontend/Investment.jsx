...
//                             >
//                                 {/* FIXED: Only show POPULAR if not sold out */}
//                                 {pkg.is_popular == 1 && pkg.is_sold_out != 1 && (
...
//                     <h2 className='text-center mb-5'> Investment Benefits</h2>
                        ...
                        <div className="col-lg-3 col-md-6" key={pkg.id}>
                            ...
                            >
                                ...
                                <div className="card-content d-flex flex-column h-100 p-3">
                                    ...
                                    {/* FIXED: All active buttons now use 'popular-btn' style */}
