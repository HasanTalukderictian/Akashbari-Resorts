    ...
    <section className="welcome-section py-5">
      <div className="container">
        <div className="row align-items-center">
          ...
          {/* Left Content Side (slides in from the left on scroll) */}
          <div
            ref={leftColRef}
            className={`col-lg-6 mb-4 mb-lg-0 anim-slide-left ${leftInView ? 'in-view' : ''}`}
          >
            <div className="d-flex align-items-center gap-3">
              <div>
                <h3 className="welcome-title text-uppercase mb-0">
          ...
          {/* Right Features Side (slides in from the right on scroll) */}
          <div
            ref={rightColRef}
            className={`col-lg-5 offset-lg-1 anim-slide-right ${rightInView ? 'in-view' : ''}`}
          >
            <div className="features-box" style={{ border: `2px solid #5e2e10` }}>
              <h2 className="features-title text-center text-uppercase mb-4">Features & Facilities</h2>
