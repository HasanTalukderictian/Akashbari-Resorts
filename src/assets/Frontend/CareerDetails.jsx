    ...
    <>
      ...
      <div className="career-details-container">
        <div className="career-details-wrapper">
          ...
          <div className="job-header">
            ...
            <div className="job-meta-grid">
              <div className="job-meta-item">
                <span className="meta-label">Tour Duration:</span>
                <span className="meta-value">{job.metaInfo.duration}</span>
              </div>
              <div className="job-meta-item">
                <span className="meta-label">Tour Price:</span>
                <span className="meta-value">{job.metaInfo.price}</span>
              </div>
              <div className="job-meta-item">
                <span className="meta-label">Tour Type:</span>
          ...
          {/* About Company */}
          <section className="details-section">
            <h2 className="section-title">{job.aboutCompany.title}</h2>
            <p className="section-text">{job.aboutCompany.description}</p>
          </section>
          ...
          <section className="apply-section">
            <h2 className="apply-title">{job.apply.title}</h2>
            <p className="apply-text">{job.apply.description}</p>
            <button className="apply-button" onClick={openApplyModal}>
              {job.apply.buttonText}
            </button>
