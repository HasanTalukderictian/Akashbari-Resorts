...
const CareerDetails = () => {
  ...
  // NEW: Auto-close success toast after 2 seconds
  useEffect(() => {
    if (showSuccess) {
  ...
  return (
    <>
      ...
      {/* NEW: Success Toast Modal */}
      {showSuccess && (
        <div className="success-toast" role="alert" aria-live="polite">
          <div className="success-toast-content">
            <div className="success-toast-icon">✓</div>
            <h3 className="success-toast-title">Thank You!</h3>
            <p className="success-toast-message">
              Your application has been submitted successfully.
            </p>
            <p className="success-toast-message" style={{ fontSize: '0.9rem', color: 'var(--cd-teal)', fontWeight: 600 }}>
              Our HR team will monitor your application.
            </p>
            <div className="success-toast-loader">
              <span></span>
              <span></span>
              <span></span>
            </div>
