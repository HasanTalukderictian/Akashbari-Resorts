...
//                           <i className="bi bi-check-circle-fill" style={styles.featureIcon}></i>
...
//                   <h6 className="mb-3" style={{ color: theme.text }}>Share this event:</h6>
//                   <div>
//                     <a 
...
//                 <i className="bi bi-calendar-event" style={styles.infoIcon}></i>
//                 <div>
...
//               <div className="d-flex align-items-center mb-4">
//                 <i className="bi bi-chat-dots" style={styles.infoIcon}></i>
//                 <div>
...
//                 <i className="bi bi-eye" style={styles.infoIcon}></i>
//                 <div>
...
//                 <i className="bi bi-geo-alt-fill" style={styles.infoIcon}></i>
...
//                 <i className="bi bi-pin-map me-2 mt-2"></i>
