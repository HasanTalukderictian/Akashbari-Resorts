...
const EventsDetails = () => {
  ...
  // ============================================================
  // FIX: Scroll page to top whenever this page / event ID loads
  // ============================================================
        ...
        <div className="container py-5">
          ...
          <div className="text-center py-5">
            ...
            <div
              ...
              style={{ ...styles.spinner, color: brandColor }}
        ...
        <div className="container">
          ...
          <div className="text-center py-3">
            ...
            >
              ...
              Discover the magic of this extraordinary event
            ...
            <div style={styles.mainCard}>
              ...
              <img
                ...
                src={
                  ...
                  getImageUrl(event.mainImg) ||

                  getImageUrl(event.thumbImg)
                ...
                <div style={styles.description}>
                  ...
                  <p>
                    ...
                    {event.description ||
                      ...
                      'Experience an unforgettable event with premium services and world-class hospitality. Join us for an amazing journey filled with joy, entertainment, and lasting memories.'}
                  ...
                  >
                    ...
                    <a
                      ...
                      onMouseEnter={(e) =>
                        ...
                        e.currentTarget.style.color = '#3d1f0a'
                    ...
                    <a
                      ...
                      href={`https://pinterest.com/pin/create/button/?url=${encodeURIComponent(shareUrl)}&description=${encodeURIComponent(event.title)}`}
