...
const Investment = ({ theme }) => {
    ...
    const handleSave = async (e) => {
        ...
        try {
            ...
            sendData.append('title', formData.title.trim());
            sendData.append('price', formData.price);
            sendData.append('share_price', formData.share_price || '0'); // New field added
            sendData.append('discount', formData.discount || '0');
            sendData.append('land', formData.land || '0');
            sendData.append('building', formData.building || '0');
            sendData.append('total_size', formData.total_size || '0');
    ...
    const openModal = (item = null) => {
        if (item) {
            ...
            setFormData({
                ...
                title: item.title || '',
                price: item.price ? item.price.toString() : '',
                share_price: item.share_price ? item.share_price.toString() : '', // New field added
                discount: item.discount ? item.discount.toString() : '',
                land: item.land || '',
                building: item.building || '',
                total_size: item.total_size || '',
                                ...
                                <div style={styles.packagesGrid}>
                                    {currentItems.map((item) => (
                                        <div key={item.id} className="package-card" style={styles.packageCard}>
                                            ...
                                            <div style={styles.cardBody}>
                                                <div style={styles.infoRow}>
                                                    <span style={styles.infoLabel}>Share Price</span>
                                                    <span style={styles.infoValue}>৳ {formatPrice(item.share_price || '0')}</span>
                                                </div>
                                                <div style={styles.infoRow}>
                                                    <span style={styles.infoLabel}>Discount Price</span>
                                                    <span style={styles.infoValue}>৳ {formatPrice(item.price || '0')}</span>
                                                </div>
                                                <div style={styles.infoRow}>
                                                    <span style={styles.infoLabel}>Full Payment Price</span>
                                                    <span style={styles.infoValue}>৳ {formatPrice(item.discount || '0')}</span>
                                                </div>
                                                <div style={styles.infoRow}>
                                                    <span style={styles.infoLabel}>Land Size</span>
                                                    <span style={styles.infoValue}>{item.land || 'N/A'} sqft</span>
                        ...
                        <form onSubmit={handleSave}>
                            ...
                            <div style={styles.modalBody}>
                                <div className="row g-3">
                                    ...
                                    <div className="col-md-6">
                                        <label style={styles.label}>Discount Price (BDT) *</label>
                                        <input
                                            type="number"
                                            style={styles.input}
                                            value={formData.price}
                                    ...
                                    <div className="col-md-6">
                                        <label style={styles.label}>Share Price (BDT) *</label>
                                        <input
                                            type="number"
                                            style={styles.input}
                                    ...
                                    <div className="col-md-6">
                                        <label style={styles.label}>Full Payment (BDT)</label>
                                        <input
                                            type="number"
                                            style={styles.input}
                                            value={formData.discount}
